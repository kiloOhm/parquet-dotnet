...
public class BoundingBox {
    ...
    internal static BoundingBox Read(ThriftCompactProtocolReader proto) {
        var r = new BoundingBox();
        proto.StructBegin();
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                case 1: // Xmin, double
                    r.Xmin = proto.ReadDouble();
                    break;
                case 2: // Xmax, double
                    r.Xmax = proto.ReadDouble();
                    break;
                case 3: // Ymin, double
                    r.Ymin = proto.ReadDouble();
                    break;
                case 4: // Ymax, double
                    r.Ymax = proto.ReadDouble();
                    break;
                case 5: // Zmin, double
                    r.Zmin = proto.ReadDouble();
                    break;
                case 6: // Zmax, double
                    r.Zmax = proto.ReadDouble();
                    break;
                case 7: // Mmin, double
                    r.Mmin = proto.ReadDouble();
                    break;
                case 8: // Mmax, double
                    r.Mmax = proto.ReadDouble();
                    break;
                default:
                    proto.SkipField(compactType);
                    break;
...
public class GeospatialStatistics {
    ...
    internal void Write(ThriftCompactProtocolWriter proto) {
        ...
        // 2: GeospatialTypes, list
        if(GeospatialTypes != null) {
            proto.WriteListBegin(2, 5, GeospatialTypes.Count);
            foreach(int element in GeospatialTypes) {
                proto.WriteI32Value(element);
            }
        }
    ...
    internal static GeospatialStatistics Read(ThriftCompactProtocolReader proto) {
        var r = new GeospatialStatistics();
        proto.StructBegin();
        int elementCount = 0;
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                case 1: // Bbox, id
                    r.Bbox = BoundingBox.Read(proto);
                    break;
                case 2: // GeospatialTypes, list
                    elementCount = proto.ReadListHeader(out _);
                    r.GeospatialTypes = new List<int>(elementCount);
                    for(int i = 0; i < elementCount; i++) { r.GeospatialTypes.Add(proto.ReadI32()); }
                    break;
                default:
                    proto.SkipField(compactType);
                    break;
...
public class VariantType {
    ...
    internal void Write(ThriftCompactProtocolWriter proto) {
        ...
        // 1: SpecificationVersion, i8
        if(SpecificationVersion != null) {
            proto.WriteByteField(1, SpecificationVersion.Value);
        }
    ...
    internal static VariantType Read(ThriftCompactProtocolReader proto) {
        ...
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                case 1: // SpecificationVersion, i8
                    r.SpecificationVersion = proto.ReadByte();
                    break;
                default:
                    proto.SkipField(compactType);
                    break;
...
public class GeometryType {
    ...
    internal void Write(ThriftCompactProtocolWriter proto) {
        ...
        // 1: Crs, string
        if(Crs != null) {
            proto.WriteStringField(1, Crs);
        }

        proto.StructEnd();
    }

    internal static GeometryType Read(ThriftCompactProtocolReader proto) {
        var r = new GeometryType();
        proto.StructBegin();
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                case 1: // Crs, string
                    r.Crs = proto.ReadString();
                    break;
                default:
                    proto.SkipField(compactType);
                    break;
...
public class GeographyType {
    ...
    internal void Write(ThriftCompactProtocolWriter proto) {
        ...
        // 2: Algorithm, id
        if(Algorithm != null) {
            proto.WriteI32Field(2, (int)Algorithm);
        }

        proto.StructEnd();
    }

    internal static GeographyType Read(ThriftCompactProtocolReader proto) {
        var r = new GeographyType();
        proto.StructBegin();
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                case 1: // Crs, string
...
public class LogicalType {
    ...
    internal void Write(ThriftCompactProtocolWriter proto) {
        ...
        // 17: GEOMETRY, id
        if(GEOMETRY != null) {
            proto.BeginInlineStruct(17);
            GEOMETRY.Write(proto);
        }
        // 18: GEOGRAPHY, id
        if(GEOGRAPHY != null) {
        ...
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                ...
                case 16: // VARIANT, id
                    ...
                    break;
                case 17: // GEOMETRY, id
                    r.GEOMETRY = GeometryType.Read(proto);
                    break;
...
public class ColumnMetaData {
    ...
    internal void Write(ThriftCompactProtocolWriter proto) {
        ...
        // 17: GeospatialStatistics, id
        if(GeospatialStatistics != null) {
            proto.BeginInlineStruct(17);
            GeospatialStatistics.Write(proto);
        }
        ...
        while(proto.ReadNextField(out short fieldId, out CompactType compactType)) {
            switch(fieldId) {
                ...
                case 16: // SizeStatistics, id
                    ...
                    break;
                case 17: // GeospatialStatistics, id
                    r.GeospatialStatistics = GeospatialStatistics.Read(proto);
                    break;
                default:
                    proto.SkipField(compactType);
                    break;
